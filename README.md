...
- **Third-party content**: the Content Security Policy in `netlify.toml` only allows the site's own files and Google Fonts. If you add another script, font or embed, add its host to the policy or the browser will block it.
...
Icons: [Font Awesome Free](https://fontawesome.com) 6.5.1 by Fonticons, Inc., licensed under [CC BY 4.0](https://fontawesome.com/license/free). Font: [Poppins](https://fonts.google.com/specimen/Poppins) (SIL Open Font License).
